...
export function Spotcard({ spot }: SpotcardProps) {
  ...
  // 1. Define who we trust (e.g., Unsplash)
  ...
  // 2. Decide the source BEFORE passing it to the <Image /> component
  ...
  return (
    <div className="flex flex-col border rounded-xl overflow-hidden bg-white shadow-sm hover:shadow-md transition-shadow duration-300">
